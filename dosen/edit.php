      ...
      <div class="col-md-8 m-auto card p-5 shadow p-3 mb-5 bg-body rounded">
        <form action="editproses.php" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="radio" name="jenjang_pendidikan" id="jenjang_pendidikan" value="S2" <?= $data['jenjang_pendidikan'] == 'S2'? 'checked': null ?>>
            <label for="jenjang_pendidikan" class="from-label">S2</label>
            <input type="radio" name="jenjang_pendidikan" id="jenjang_pendidikan" value="S3" <?= $data['jenjang_pendidikan'] == 'S3'? 'checked': null ?>>
            <label for="jenjang_pendidikan" class="from-label">S3</label>
          </div>
